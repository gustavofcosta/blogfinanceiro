...
export default function Price({ filteredCoins }: Props) {
    ...
    return (
        <Carousel
            ...
            className='flex bg-gray-900 h-14 justify-start fixed w-[19999px] text-[11px] z-10'>
                ...
                <div className="flex font-bold flex-col justify-center items-center space-y-1"
                    ...
                    <div className="flex justify-center items-center ">
                        {coin.price_change_percentage_24h < 0 ? (
                            <>
                                <p className="text-red-600  mr-2">R$ {coin.current_price}</p>
                                <p className="text-red-600">{coin.price_change_percentage_24h.toFixed(2)}%</p>
                            </>

                        ) : (
                            <>
                                <p className="text-green-600  mr-2">R$ {coin.current_price}</p>
