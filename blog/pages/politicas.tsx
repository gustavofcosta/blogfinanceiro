...
export default function Politicas({ filteredCoins, title, url }: Props) {
    return (
        <>
            <NextSeo
            ...
            <div className="max-w-7xl mx-auto">
                <div className="mt-8 space-y-7 p-5 ">

                    <h2 className="text-2xl font-bold uppercase">Política Privacidade</h2>

                    <p>A sua privacidade é importante para nós. É política do coininfo respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <Link href='/'>coininfo</Link>, e outros sites que possuímos e operamos.</p>
                    ...
                    <h2 className="text-2xl font-bold uppercase">Política de Cookies coininfo</h2>
                    ...
                    <h3 className="text-xl font-bold uppercase">Como usamos os cookies?</h3>

                    <p>Utilizamos cookies por vários motivos, detalhados abaixo. Infelizmente, na maioria dos casos, não existem opções padrão do setor para desativar os cookies sem desativar completamente a funcionalidade e os recursos que eles adicionam a este site. É recomendável que você deixe todos os cookies se não tiver certeza se precisa ou não deles, caso sejam usados para fornecer um serviço que você usa.</p>

                    <h3 className="text-xl font-bold uppercase">Desativar cookies</h3>
                    <p>Você pode impedir a configuração de cookies ajustando as configurações do seu navegador (consulte a Ajuda do navegador para saber como fazer isso). Esteja ciente de que a desativação de cookies afetará a funcionalidade deste e de muitos outros sites que você visita. A desativação de cookies geralmente resultará na desativação de determinadas funcionalidades e recursos deste site. Portanto, é recomendável que você não desative os cookies.</p>

                    <h3 className="text-xl font-bold uppercase">Cookies que definimos</h3>
                    <ul className="p-5">
                        ...
                        <li> Cookies relacionados a boletins por e-mail<br /><br /> Este site oferece serviços de assinatura de boletim informativo ou e-mail e os cookies podem ser usados para lembrar se você já está registrado e se deve mostrar determinadas notificações válidas apenas para usuários inscritos / não inscritos.<br /><br />
                        </li>
                    ...
                    <h3 className="text-xl font-bold uppercase">Cookies de Terceiros</h3>
                    ...
                    <h3 className="text-xl font-bold uppercase">Compromisso do Usuário</h3>

                    <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o coininfo oferece no site e com caráter enunciativo, mas não limitativo:</p>
                    ...
                    <ul className="space-y-5 p-5">
                        ...
                        <li>C - Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do coininfo, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>

                    </ul>

                    <h3 className="text-xl font-bold uppercase">Mais informações</h3>

                    <p className="font-semibold text-red-600">Nada publicado pelo CoinInfo constitui em uma recomendação de investimento, e nenhum dado ou conteúdo publicado deve ser utilizado para quaisquer atividades de investimento.</p>
